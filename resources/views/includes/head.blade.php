...
<title>Burger Job</title>

<!-- Google Font: Source Sans Pro -->
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
<!-- <link rel="stylesheet" href="{{ asset('font/FreeSans.ttf')}}"> -->
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ asset('templates/plugins/fontawesome-free/css/all.min.css')}}">
<!-- icheck bootstrap -->
<link rel="stylesheet" href="{{ asset('templates/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
<!-- DatePicker -->
<link href="{{ asset('datepicker/dist/css/datepicker.min.css')}}" rel="stylesheet" type="text/css">
<!-- Select2 -->
...
<!-- Trix Editor -->
<link rel="stylesheet" type="text/css" href="{{ asset('front/css/trix.css')}}">
<!-- Theme style harus dibawah karena kalau diatas rel yg lain tema bs tidak masuk-->
...
<!-- Trix Editor -->
<script type="text/javascript" src="{{ asset('front/js/trix.js')}}"></script>
<!-- Select2 -->
