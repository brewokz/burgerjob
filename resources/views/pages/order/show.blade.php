            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4>
                                ...
                                <small class="float-right">Date: {{date_format(date_create($order->date),"d-m-Y")}}</small>
                            </h4>
                        </div>
                        <!-- /.col -->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-6">
                            <p class="lead">{{date_format(date_create($order->date),"d-m-Y")}}</p>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        @if($order->amount_split_bill == null)
                                        <td>-</td>
                                        @else
                                        <td>Rp. {{number_format($order->amount_split_bill)}}</td>
                                        @endif
                                    </tr>
                                    <tr>
                                        <th>Total:</th>
                    ...
                    <div class="row no-print mt-5">
                        <div class="col-12">
                            <a href="/order" class="btn bg-gradient-info float-right ml-3"></i>Back</a>
