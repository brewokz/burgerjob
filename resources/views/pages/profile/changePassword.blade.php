...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="/profile-password/{{$user->id}}">
                @method('PATCH')
                @csrf
                ...
                <div class="form-group row float-sm-right p-2 col-sm-2">
                    <div class="col">
                        <button type="submit" class="btn btn-block bg-gradient-orange text-white btn-lg">Update Password</button>
                    </div>
                </div>
